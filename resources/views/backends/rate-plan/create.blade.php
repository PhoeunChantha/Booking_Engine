                                ...
                                <div class="row ">
                                    <div class=" col-md-6">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="d-flex justify-content-between gap-5">
                                                <div class="container-guests">
                                                    <select class="form-control" name="guests_allowed[]" id="guests_allowed">
                                                        @for ($i = 1; $i <= 100; $i++)
                                                            <option value="{{ $i }}">{{ $i }}
                                                            </option>
                                                        @endfor
                                                ...
                                                <div class="container-guests">
                                                    <select class="form-control" name="guests_allowed[]" id="extra_options"
                                                       >
                                                        <option value="extra adult or child">extra adult or child</option>
                                                        <option value="extra adult only">extra adult only</option>
                                                        <option value="extra child only">extra child only</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="derived-section" style="display:none ;">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="custom_adjust justify-content-between d-flex">
                                                    ...
                                                    <input type="text" name="adjust_rates[]"
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="meals_included" role="group"
                                                ...
                                                <input name="meals_included[]" value="Breakfast" type="checkbox" class="btn-check" id="btncheck1"
                                                    autocomplete="off" data-meal="Breakfast">
                                                <label class="btn" for="btncheck1">Breakfast</label>

                                                <input name="meals_included[]" value="Lunch" type="checkbox" class="btn-check" id="btncheck2"
                                                    autocomplete="off" data-meal="Lunch">
                                                <label class="btn" for="btncheck2">Lunch</label>

                                                <input name="meals_included[]" value="Dinner" type="checkbox" class="btn-check" id="btncheck3"
                                                    autocomplete="off" data-meal="Dinner">
                                                <label class="btn" for="btncheck3">Dinner</label>

                                                <input name="meals_included[]" value="All Inclusive" type="checkbox" class="btn-check" id="btncheck4"
                                                    autocomplete="off" data-meal="All Inclusive">
                                    ...
                                    <div class=" col-md-6">
                                        ...
                                        <div class="form-group col-md-12" id="last_minute-section">
                                            ...
                                            <div style="gap: 10px" class="custome_last d-flex">
                                                ...
                                                <input id="last_minute_amount" type="text" name="last_minute_default[]"
                                                    class="form-control">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div role="group" aria-label="Basic radio toggle button group">
                                                <input value="No" type="radio" class="btn-check" name="inclusions[]" id="inclusion1"
                                                    autocomplete="off" checked>
                                                <label class="btn" for="inclusion1">No</label>

                                                <input value="Yes" type="radio" class="btn-check" name="inclusions[]" id="inclusion2"
                                                    autocomplete="off">
                                        ...
                                        <div class="container-inclusion-form" id="inclusion-form">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input name="inclusions[]" type="text" class="form-control" id="inclusions_name">
                                            </div>
                                            <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="" role="group"
                                                aria-label="Basic radio toggle button group">
                                                <input value="No" type="radio" class="btn-check" name="reference_rates[]"
                                                    id="reference_rate1" autocomplete="off" checked>
                                                <label class="btn " for="reference_rate1">No</label>

                                                <input value="Yes" type="radio" class="btn-check" name="reference_rates[]"
                                                    id="reference_rate2" autocomplete="off">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row container-form d-flex  align-items-center">
                                                <div class="form-group col-md-3" id="inclusions-input">
                                                    ...
                                                    <input name="reference_rates[]" type="text" class="form-control " id="Inclusions">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12" id="advanced-package">
                                            ...
                                            <div style="gap: 10px"
                                                ...
                                                <select class="form-control w-50" name="additional_nights[]" id="change-nights">
                                                    <option value="regular">Regular Rates</option>
                                                    <option value="fixed">Fixed Rate</option>
                                                    <option value="specific">Specific Rate Plan</option>
                                                </select>
                                                <select class="form-control w-50" name="additional_nights[]" id="change-select">
                                                ...
                                                <input id="fixed_input" placeholder="0" type="text"
                                                    class="form-control w-50 mr-2" name="additional_nights[]" style="display: none;">
                                                <select name="additional_nights[]" class="form-control w-50" id="specific_rate"
                                                    style="display: none;">
                                                    <option value=""></option>
                                                    @foreach ($ratePlans as $id => $title)
                                                        <option value="{{ $id }}">{{ $title }}</option>
                                                ...
                                                <div class="form-group align-items-center" id="input-div"
                                                    style="display: none;">
                                                    <input name="additional_nights[]" placeholder="0" type="text" class="form-control w-25 mr-2"
                                                        name="" id="">%
                                                </div>
