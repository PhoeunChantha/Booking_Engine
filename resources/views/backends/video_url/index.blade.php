                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    {{-- <a class="btn btn-primary  float-right" data-toggle="modal" data-target="#videourlmodal"
                                        href="#">
                                        <i class=" fa fa-plus-circle"></i>
                                        {{ __('Add New') }}
                                    </a> --}}
                                    <a class="btn btn-primary btn-modal float-right" href="#"
                                        data-href="{{ route('admin.video_url.create') }}" data-toggle="modal"
                        ...
                        @include('backends.video_url._table')
                    </div>
                </div>
            </div>
        </div>
...
@push('js')
    <script>
        ...
        $('input.status').on('change', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.video_url.update_status') }}",
                data: {
                    id: id,
                    _token: "{{ csrf_token() }}"
                },
