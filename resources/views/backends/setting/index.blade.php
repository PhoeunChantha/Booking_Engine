                            ...
                            <form action="{{ route('admin.setting.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">{{ __('Comment Image') }}</h3>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="comment_image">{{ __('Image') }}</label>
                                                            <div class="preview">
                                                                <img src="
                                                            @if ($comment_image && file_exists('uploads/business_settings/' . $comment_image)) {{ asset('uploads/business_settings/' . $comment_image) }}
                                                            @else
                                                                {{ asset('uploads/image/default.png') }} @endif
                                                            "
                                                            ...
                                                            <div class="custom-file">
                                                                <input type="file"
                                                                    class="custom-file-input custom-file-input_image1"
                                                                    id="customFile" name="comment_image">
                                                                <label class="custom-file-label"
                                                                    for="customFile">{{ __('Choose file') }}</label>
                                                            </div>
                                                        </div>
