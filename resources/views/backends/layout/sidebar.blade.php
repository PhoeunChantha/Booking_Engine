        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                @endif
                <li class="nav-item">
                    <a href="{{ route('admin.guest_management.index') }}"
                        class="nav-link @if (request()->routeIs('admin.guest_management*')) active @endif">
                ...
                @if (auth()->user()->can('hotelmanagement.view'))
                    <li class="nav-item">
                        <a href="{{ route('admin.hotel_management.index') }}"
                            class="nav-link @if (request()->routeIs('admin.hotel_management.*')) active @endif">
                            {{-- <i class="nav-icon fas fa-ad"></i> --}}
                            @include('svgs.hotel_management')
                            <p>
                                {{ __('Hotel Management') }}
                            </p>
                        </a>
                ...
                <li class="nav-item @if (request()->routeIs('admin.room*', 'admin.roomtype*', 'admin.bedding*')) menu-is-opening menu-open @endif">
                    <a href="#" class="nav-link @if (request()->routeIs('admin.room*', 'admin.roomtype*', 'admin.bedding*')) active @endif">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @if (auth()->user()->can('room.view'))
                            <li class="nav-item">
                                <a href="{{ route('admin.roomtype.index') }}"
                                    class="nav-link @if (request()->routeIs('admin.roomtype*')) active @endif">
                                    @include('svgs.bed')
                                    <p>
                                        {{ __('Room Type') }}
                                    </p>
                        ...
                        @if (auth()->user()->can('room.view'))
                            <li class="nav-item">
                                <a href="{{ route('admin.bedding.index') }}"
                                    class="nav-link @if (request()->routeIs('admin.bedding*')) active @endif">
                                    @include('svgs.bed')
                                    <p>
                                        {{ __('Bedding') }}
                                    </p>
                ...
                @endif
                <li class="nav-item">
                    <a href="{{ route('admin.video_url.index') }}"
                        class="nav-link @if (request()->routeIs('admin.video_url*')) active @endif">
                ...
                @if (auth()->user()->can('setting.view') ||
                        auth()->user()->can('accommodation.view') ||
                        auth()->user()->can('bookingcondition.view'))
                    <li class="nav-item @if (request()->routeIs('admin.setting*', 'admin.accommodation.*', 'admin.bookingcondition.*')) menu-is-opening menu-open @endif">
                        <a href="#" class="nav-link @if (request()->routeIs('admin.setting*', 'admin.accommodation.*', 'admin.bookingcondition.*')) active @endif">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endif
                            @if (auth()->user()->can('accommodation.view'))
                                <li class="nav-item">
                                    <a href="{{ route('admin.accommodation.index') }}"
                                        class="nav-link @if (request()->routeIs('admin.accommodation.*')) active @endif">
                                        <i class="fa-solid fa-circle nav-icon"></i>
                                        {{-- @include('svgs.setting') --}}
                                        <p>
                            ...
                            @endif
                            @if (auth()->user()->can('bookingcondition.view'))
                                <li class="nav-item">
                                    <a href="{{ route('admin.bookingcondition.index') }}"
                                        class="nav-link @if (request()->routeIs('admin.bookingcondition.*')) active @endif">
                                        <i class="fa-solid fa-circle nav-icon"></i>
                                        {{-- @include('svgs.setting') --}}
                                        <p>
                                            {{ __('Booking Conditions') }}
                                        </p>
                                    </a>
                                </li>
                            @endif
