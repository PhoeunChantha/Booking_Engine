...
@section('contents')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3>{{ __('Bedding Configuration') }}</h3>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h3 class="card-title">{{ __('Bedding List') }}</h3>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if (auth()->user()->can('gallery-category.create'))
                                        <a class="btn btn-primary btn-modal float-right" href="#"
                                            data-href="{{ route('admin.bedding.create') }}" data-toggle="modal"
                        ...
                        {{-- table --}}
                        @include('backends.room.bedding._table')
...
@push('js')
    <script>
        ...
        $('input.status').on('change', function() {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('admin.bedding.update_status') }}",
                data: {
                    "id": $(this).data('id')
                },
                dataType: "json",
