...
@section('contents')
                                                    ...
                                                    <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="description_{{ $lang['code'] }}" class="form-control  @error('description') is-invalid @enderror"
                                                                name="description[]" rows="3">{{ $translate[$lang['code']]['description'] ?? $room['description'] }}</textarea>
                                                        </div>
                                                        <!-- <div class="row">
    ...
    @enderror
                                                                                                                    ...
                                                                                                                    <div class="form-group col-md-4 col-12">
                                                                                                                        ...
                                                                                                                        <textarea id="bathroom_{{ $lang['code'] }}" class="form-control summernote @error('bathroom') is-invalid @enderror"
                                                                                                                            name="bathroom[]" placeholder="{{ __('Type Something') }}" rows="4">{{ $translate[$lang['code']]['bathroom'] ?? $room['bathroom'] }}</textarea>
                                                                                                                        @error('bathroom')
        <span class="invalid-feedback" role="alert">
                                                                                                                                                                                        <strong>{{ $message }}</strong>
                                                                                                                                                                                    </span>
    @enderror
                                                                                                                    ...
                                                                                                                    <div class="form-group col-md-4 col-12">
                                                                                                                        ...
                                                                                                                        <textarea id="bedroom_{{ $lang['code'] }}" class="form-control summernote @error('bedroom') is-invalid @enderror"
                                                                                                                            name="bedroom[]" placeholder="{{ __('Type Something') }}" rows="4">{{ $translate[$lang['code']]['bedroom'] ?? $room['bedroom'] }}</textarea>
                                                                                                                        @error('bedroom')
        <span class="invalid-feedback" role="alert">
                                                                                                                                                                                        <strong>{{ $message }}</strong>
                                                                                                                                                                                    </span>
    ...
    @enderror
                                                                                                                    ...
                                                                                                                    <div class="form-group col-md-4 col-12">
                                                                                                                        ...
                                                                                                                        <textarea id="internet_{{ $lang['code'] }}" class="form-control summernote @error('internet') is-invalid @enderror"
                                                                                                                            name="internet[]" placeholder="{{ __('Type Something') }}" rows="4">{{ $translate[$lang['code']]['internet'] ?? $room['internet'] }}</textarea>
                                                                                                                        @error('internet')
        <span class="invalid-feedback" role="alert">
                                                                                                                                                                                        <strong>{{ $message }}</strong>
                                                                                                                                                                                    </span>
    @enderror
                                                                                                                    ...
                                                                                                                    <div class="form-group col-md-4 col-12">
                                                                                                                        ...
                                                                                                                        <textarea id="more_{{ $lang['code'] }}" class="form-control summernote @error('more') is-invalid @enderror"
                                                                                                                            name="more[]" placeholder="{{ __('Type Something') }}" rows="4">{{ $translate[$lang['code']]['more'] ?? $room['more'] }}</textarea>
                                                                                                                        @error('more')
        <span class="invalid-feedback" role="alert">
                                                                                                                                                                                        <strong>{{ $message }}</strong>
                                                                                                                                                                                    </span>
    ...
    @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input readonly type="text"
                                            ...
                                            placeholder="{{ __('Code') }}" min="0" step="1">
                                        @error('code')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('roomtype_id') is-invalid @enderror"
                                            id="roomtype_select" onchange="updateRoomSizeLabel()" name="roomtype_id">
                                            <option value="">{{ __('Select Room Type') }}</option>
                                            @foreach ($roomtypes as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ old('roomtype_id', $room->roomtype_id) == $id ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="max_room">{{ __('Max Rooms Available') }}</label>
                                        <input type="number"
                                            class="form-control @error('max_room') is-invalid @enderror"
                                            value="{{ old('max_room', $room->max_room) }}" name="max_room"
                                            placeholder="{{ __('Enter max rooms ') }}" min="0" step="1">
                                        @error('max_room')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label id="room_size_label" for="room_size">{{ __('Size') }}</label>
                                        <div class="roomsize d-flex">
                                            <input type="text"
                                                class="form-control mr-3 @error('room_size') is-invalid @enderror"
                                                value="{{ old('room_size', $roomSizeValue) }}" id="room_size_input"
                                                placeholder="{{ __('Enter room size') }}">
                                            @error('room_size')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            @enderror
                                            <select class="form-control" id="room_size_unit">
                                                <option value="m²" {{ $roomSizeUnit == 'm²' ? 'selected' : '' }}>m²
                                                </option>
                                                <option value="ft²" {{ $roomSizeUnit == 'ft²' ? 'selected' : '' }}>ft²
                                                </option>
                                            </select>
                                        </div>
                                        <input type="hidden" name="room_size" id="room_size">
                                    </div>
                                    ...
                                    {{-- <div class="form-group col-md-12">
                                        ...
                                        <textarea type="text" class="form-control @error('description') is-invalid @enderror"
                                            value="{{ old('description') }}" name="description" placeholder="{{ __('Enter description') }}"></textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="max_bedding">{{ __('Maximum Bedding Configuration ') }}</label>
                                        <div class="row">
                                            @php
                                                // Decoding the JSON data from the database
                                                $maxBedding = json_decode($room->maximum_bedding, true);
                                            @endphp

                                            @forelse ($beddings as $bedding)
                                                <div class="col-6">
                                                    <div class="container-select d-flex">
                                                        <select class="form-control w-25 bedding-select"
                                                            name="max_bedding[{{ $bedding->name }}]">
                                                            @for ($i = 0; $i <= 20; $i++)
                                                                <option value="{{ $i }}" {{-- Checking if the $maxBedding array has the value for the specific bedding name --}}
                                                                    {{ isset($maxBedding[$bedding->name]) && $maxBedding[$bedding->name] == $i ? 'selected' : '' }}>
                                                                    {{ $i }}
                                                                </option>
                                                            @endfor
                                                        </select>
                                                        <span class="bedding-label">{{ $bedding->name }}</span>
                                                    </div>
                                                </div>
                                            @empty
                                                <div class="empty">
                                                    <span
                                                        class="text-red text-center fw-bold">{{ __('No Bedding Available') }}</span>
                                                </div>
                                            @endforelse
                                    ...
                                    {{-- <input type="hidden" name="max_bedding[]" id="max_bedding_input"> --}}
                                    <div class="form-group col-md-6">
                                        @php
                                            // Decoding the JSON data from the database
                                            $extraBedding = json_decode($room->extra_bedding, true);
                                        @endphp
                                        <label
                                            style="background-color: #bfc0c3; color: black; cursor: pointer; padding: 5px; border-radius: 5px;"
                                            for="add_extra" onclick="toggleBeddingConfig()">
                                            {{ __('Add Extra Bedding Configuration ') }}
                                        </label>
                                        <div class="container-extra" id="add_extra"
                                            style="display: {{ $extraBedding ? 'block' : 'none' }}">
                                            <div class="row d-flex">
                                                ...
                                                @forelse ($beddings as $bedding)
                                                    <div class="col-6">
                                                        <div class="container-select d-flex">
                                                            <select class="form-control w-25 bedding-select"
                                                                name="extra_bedding[{{ $bedding->name }}]">
                                                                @for ($i = 0; $i <= 20; $i++)
                                                                    <option value="{{ $i }}"
                                                                        {{-- Checking if the $extraBedding array has the value for the specific bedding name --}}
                                                                        {{ isset($extraBedding[$bedding->name]) && $extraBedding[$bedding->name] == $i ? 'selected' : '' }}>
                                                                        {{ $i }}
                                                                    </option>
                                                                @endfor
                                                            </select>
...
@push('js')
    {{-- <script>
        $(document).ready(function() {
            function updateRoomSize() {
                var roomSizeInput = $('#room_size_input').val();
                var roomSizeUnit = $('#room_size_unit').val();
                $('#room_size').val(roomSizeInput + ' ' + roomSizeUnit);
            }

            // Update the hidden field whenever the input or select changes
            $('#room_size_input').on('input', updateRoomSize);
            $('#room_size_unit').on('change', updateRoomSize);

            // Initial update on page load in case of edit
            updateRoomSize();
        });
    </script> --}}
    <script>
        $(document).ready(function() {
            function updateRoomSize() {
                var selectElement = document.getElementById('roomtype_select');
                var selectedText = selectElement.options[selectElement.selectedIndex].text;
                var roomSizeInput = $('#room_size_input').val();
                var roomSizeUnit = $('#room_size_unit').val();
                $('#room_size').val(selectedText + ' ' + roomSizeInput + ' ' + roomSizeUnit);
            }
    ...
    <script>
        function updateRoomSizeLabel() {
            var selectElement = document.getElementById('roomtype_select');
            var selectedText = selectElement.options[selectElement.selectedIndex].text;
            var sizeLabel = document.getElementById('room_size_label');
            sizeLabel.textContent = selectedText + ' {{ __('Size') }}';
        }
    </script>
    <script>
        function toggleBeddingConfig() {
            var beddingConfig = document.getElementById('add_extra');
            beddingConfig.style.display = beddingConfig.style.display === 'none' || beddingConfig.style.display === '' ?
                'block' : 'none';
        }
    </script>
    <script>
